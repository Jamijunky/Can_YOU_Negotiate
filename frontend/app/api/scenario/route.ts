...
OUTPUT JSON FORMAT:
{
  ...
  "secondary_goals": ["List of 1-2 things they also want but could compromise on"],
  ...
  "possible_concessions": ["List of 1-3 things this person might give up if sufficiently persuaded"],
  "communication_style": {
...
const FALLBACK_SCENARIOS = [
  {
    ...
    secondary_goals: ["Protect your daughter from the people you exposed"],
    ...
    possible_concessions: ["Turning over the evidence in exchange for protection", "Testifying publicly"],
  ...
  },
  {
    ...
    secondary_goals: ["Make sure someone understands what the surveillance program does"],
    ...
    possible_concessions: ["Letting them cut the transmission if the files are already public", "Coming out if given immunity"],
  ...
  },
  {
    ...
    secondary_goals: ["Make sure the foreman faces consequences"],
    ...
    possible_concessions: ["Coming down if the money is brought to you in cash", "Accepting a payment plan if it's guaranteed"],
  ...
  },
  {
    ...
    secondary_goals: ["Make sure your disability benefits are protected"],
    ...
    possible_concessions: ["Letting a housing inspector in if they're independent", "Agreeing to mediation if the landlord is held accountable"],
